...
export interface GetLessionBySlug {
   lesson: LessonEventPage;
};

export const Video: FunctionComponent<VideoComponentProps> = ({ lessonSlug }) => {

   const { data } = useQuery<GetLessionBySlug>(GET_LESSON_WITH_SLUG, {
      variables: {
         slug: lessonSlug,
      }
   });
